...
public class RegisterNewUser
{
    ...
    private void Register()
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("Inser_User"))
            {
            ...
            switch (userId)
            {
                ...
                case -2:
                    ...
                    break;
                default:
                    message = "Registration successtful.\\Please check your email for activation link";
    ...
    private void SendActivationEmail(int userId)
    {
        ...
        using (SqlConnection con = new SqlConnection(constr))
        {
            using (SqlCommand cmd = new SqlCommand(SQLQuery.InsertActivetionCode))
            {
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
